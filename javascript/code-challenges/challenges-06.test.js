...
const getNames = (arr) => {
  // Solution code here...
  const arrGetNames = arr.map((value) => {
    const nameNotReversed = value.name;
    const splitElement = nameNotReversed.split('');
    const reverseElement = splitElement.reverse();
...
the object called yearBorn. The value of the yearBorn property should be the integer that
was passed in.

...
const toLastNames = people => {
  // Solution code here...
  const arrToLastNames = [];
  people.map(value => {
    arrToLastNames.push(value.firstName + ' ' + value.lastName);
  });
  return arrToLastNames;
};
...
const addPurchases = (arr) => {
  // Solution code here...
  const arrAddPurchases = arr.reduce((acc, value) => {
    return acc += value.purchasePrice;
  },0);
  return arrAddPurchases;
};

/* ------------------------------------------------------------------------------------------------
CHALLENGE 4

Write a function named countNumberOfElements that, given an array as input, uses reduce to count the number of
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  const numCountNumberOfElements = arr.reduce((acc, value) => {
    acc = value;
    value++;
    return acc;
  });
  return numCountNumberOfElements;
};
...
const returnNames = (arr) => {
  // Solution code here...
  const arrReturnNames = [];
  arr.reduce((acc, value) => {
    acc = value.name;
    arrReturnNames.push(acc);
  },{});
  return arrReturnNames;
};
...
const reversedString = (str) => {
  // Solution code here...
  let newReversedString = str.split('');
  console.log(newReversedString);
  const arrReversedString = newReversedString.reduce((acc, value) => {
    acc = value + acc;
    return acc;
  });
  return arrReversedString;
};

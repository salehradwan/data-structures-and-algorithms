...
const typeNum = (arr) => {
  // Solution code here...
  const arrTypeNum = arr.filter(value => {
    if (!isNaN(value)) {
      return true;
    }
  });
...
const containsAnd = (arr) => {
  // Solution code here...
  const arrContainsAnd = arr.filter((value) => value.includes('and'));
...
Write a function named oddValues that, given an array of integers as input, uses filter to return an array
...
const oddValues = (arr) => {
  // Solution code here...
  const arrOddValues = arr.filter(value => value % 2 !== 0);
  return arrOddValues;
};
...
const notInFirstArray = (forbiddenValues, arr) => {
  // Solution code here...
  const arrNotInFirstArray = arr.filter(value => forbiddenValues.includes(value) !== arr.includes(value));
  // const arrNotInFirstArray = arr.filter(value => {
  //   if (forbiddenValues.includes(value) !== arr.includes(value)) {
  //     return true;
  //   }
  // });
  return arrNotInFirstArray;
};
